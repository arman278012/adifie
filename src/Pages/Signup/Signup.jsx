...
const Signup = () => {
  ...
  const handleRegister = () => {
    ...
    axios
      .post("https://adifie.cyclic.app/user/register", {
        name,
        email,
        mobile,
        password,
  ...
  return (
    <div>
      <div className={`flex items-center  bg-blue-500 text-white text-sm font-bold px-4 py-3 ${error ? "block" : "hidden"}`} role="alert">
      ...
      <div className="flex h-screen">
        {/* <!-- Left Pane --> */}
        <div className="hidden sm:block items-center justify-center flex-1 bg-black text-white">
        ...
        <div className="w-full bg-gray-100 lg:w-1/2 flex items-center justify-center">
          <div className="max-w-md w-full p-6">
            ...
            <h1 className="text-sm font-semibold mb-6 text-gray-500 text-center">
              Join to Our Group for the best Advertisement.{" "}
            </h1>
            <form action="#" method="POST" className="space-y-4" onSubmit={handleRegister}>
